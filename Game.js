...
function Game(){
	...
	function getBid(ai){
		...
		if(__biddingRound === 1){
			...
			animShowText("Player " + __currentPlayer + " passed.");
		}
	...
	function orderUp(){
		...
		if(ai === null){
			...
			giveDealerTrump(ai.pickDiscard());
		}
	...
	this.myHand = function(){
		return __hands[__currentPlayer];
	}
}
